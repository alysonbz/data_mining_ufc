...
if __name__ == "__main__":
    X, y = load_dataset(r'C:\Users\Guilherme\Desktop\Mineração\data_mining_ufc\AV2\classificacao_de_tempo')
    # Salva para uso nos próximos scripts
    np.save(r'C:\Users\Guilherme\Desktop\Mineração\data_mining_ufc\AV2\scripts\X.npy', X)
    np.save(r'C:\Users\Guilherme\Desktop\Mineração\data_mining_ufc\AV2\scripts\y.npy', y)
