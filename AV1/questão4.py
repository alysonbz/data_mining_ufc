...
# Carregar os dados
data = "Tweets_atualizado.csv"
df = pd.read_csv(data)

# Gerar os atributos numéricos
df_term_freq, tfidf_term_freq, df_matrix, tfidf_matrix = generete_numerics_atributes(df, column='text')

# Separar os dados em treino e teste
X_train_df, X_test_df, y_train, y_test = train_test_split(df_matrix, df['sentiment'], test_size=0.2, random_state=42)
X_train_tfidf, X_test_tfidf, _, _ = train_test_split(tfidf_matrix, df['sentiment'], test_size=0.2, random_state=42)
