...
# treino e teste
X_train_df, X_test_df, y_train, y_test = train_test_split(df_matrix, df['Cons_rating'], test_size=0.2, random_state=42)
X_train_tfidf, X_test_tfidf, _, _ = train_test_split(tfidf_matrix, df['Cons_rating'], test_size=0.2, random_state=42)

# Treinar Document Frequency
...
# Matriz de Confusão para Document Frequency
