...
# Imprime as cinco primeiras listas de tokens
...
# Substitua os tokens nos exemplos abaixo pelos seus tokens reais.
tokens_list = [
...
# Crie uma única figura com vários subplots.
fig, axs = plt.subplots(1, 5, figsize=(20, 4))

# Plote os cinco primeiros conjuntos de tokens nos subplots.
