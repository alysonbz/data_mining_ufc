...
print("media de valores de pixel na imagem não eq: ",img_mean_eq )
...
print("numero de pixels com probabilidde de ocorrencia menor que,", l_freq , " na imagem eq: ",len(low_freq_region_n_eq[0]))
