...
hist_n_eq, bins_n_eq = np.histogram(image_aerial.ravel(), bins=256)
plt.hist(hist_n_eq, bins=256)
...
hist_eq, bins_eq = np.histogram(image_eq.ravel(), bins=256)
plt.hist(hist_eq, bins=256)
