...
gaussian_image_s5 = gaussian(building_image, sigma=5)

# Show resulting image to compare
show_image(gaussian_image_s5, "Reduced sharpness Gaussian with sigma = 5")

# Apply filter sigma = 10
gaussian_image_s10 = gaussian(building_image, sigma=10)

# Show resulting image to compare
show_image(gaussian_image_s10, "Reduced sharpness Gaussian with sigma = 10")